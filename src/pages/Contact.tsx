            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
              <Card className="glass-card glass-hover rounded-xl border-leather-tan/20">
                <CardContent className="pt-6 text-center">
                  <Mail className="h-12 w-12 text-leather-cognac mx-auto mb-4" />
              ...
              <Card className="glass-card glass-hover rounded-xl border-leather-tan/20">
                <CardContent className="pt-6 text-center">
                  <Phone className="h-12 w-12 text-leather-gold mx-auto mb-4" />
              ...
              <Card className="glass-card glass-hover rounded-xl border-leather-tan/20">
                <CardContent className="pt-6 text-center">
                  <MapPin className="h-12 w-12 text-leather-cognac mx-auto mb-4" />
